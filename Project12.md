...
![Alt text](Ansible-refactoring/ansible_build.png)
...
```
![Alt text](<Ansible-refactoring/script run.png>)
...
![Alt text](<Ansible-refactoring/final display.png>)
